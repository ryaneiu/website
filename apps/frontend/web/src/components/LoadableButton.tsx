...
export function LoadableButton(props: LoadableButtonProps) {
    ...
    return <Button {...props} icon={icon} iconAtRight={props.iconAtRight} isPrimary={props.isPrimary} onClick={props.onClick} disabled={props.isLoading || props.disabled}></Button>
}