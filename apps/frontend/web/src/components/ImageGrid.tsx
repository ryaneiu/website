...
export const ImageGrid: React.FC<ImageGridProps> = ({
    ...
    if (count === 2) {
        return (
            <div className="grid grid-cols-2 gap-1 h-128 w-full overflow-hidden rounded-2xl border border-black/15 dark:border-white/15">
    ...
    if (count === 3) {
        return (
            <div className="grid grid-cols-2 grid-rows-2 gap-1 h-128 w-full overflow-hidden rounded-2xl border border-black/15 dark:border-white/15">
