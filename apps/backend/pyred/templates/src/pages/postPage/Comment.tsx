...
export function Comment(props: Props) {
    ...
    const onReplyClicked = async (textContent: string) => {
        await props.onReplyCreate(props.comment.id, textContent);
        setReplying(false);
    };
        ...
        <div className="w-full flex flex-col gap-2 px-2 py-2">
            <details open>
                ...
                <div className="ml-2 pl-2 relative">
                    <div className="absolute left-0 top-0 w-[1px] bg-black/20 dark:bg-white/20 h-full transition-colors duration-300"></div>
                    <div
                    ...
                    >
                        ...
                        {replying && (
                            <CommentReplySection
                                ...
                                setVisible={setReplying}
                                placeholder={`Reply to @${props.comment.author}`}
                            ></CommentReplySection>
                        )}
